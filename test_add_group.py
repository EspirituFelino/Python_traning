...
class TestAddGroup(unittest.TestCase):
    ...
    def test_add_group(self):
        ...
        self.create_group(wd, group_name="asdfsadf", group_header="dfgdsvdf", group_footer="qwefsadc")
    ...
    def create_group(self, wd: WebDriver, group_name, group_header, group_footer):
        # init group creation
